                                    ...
                                    <div class="card-body cards">
                                        <form id="form" class="form-horizontal" οnsubmit="return false;" enctype="multipart/form-data"  target="addfile">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="title" type="text" class="form-control" placeholder="文章标题" name="title" value="<?php echo htmlentities($article['title']); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control select2 w-100"  name="typeId">
                                                        <option value="<?php echo htmlentities($article['typeId']); ?>"><?php echo htmlentities($article['typename']); ?></option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                **Editor.md** 是一款开源的、可嵌入的 Markdown 在线编辑器（组件），基于 CodeMirror、jQuery 和 Marked 构建。
                                                    ...
                                                    <textarea id="summernote" name="content"><?php echo htmlentities($article['content']); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div id='readImg' class="col-md-8">
                                                    <input type="hidden" id="imgs" name="imgs"value="<?php echo htmlentities($article['picture']); ?>" >
                                                    <img src="/../static<?php echo htmlentities($article['picture']); ?>" width="90%" height="90%" />
                                                </div>

    ...
    <ul class="side-menu">
									...
									<div class="card">
										...
										<div class=" col-lg-12" style="margin-top:20px;margin-bottom: -10px;">
											<div class="float-left" style="margin-right: 10px;">
												<a href="<?php echo url('type/add'); ?>" class="btn btn-primary" >添加分类</a> 
											</div>
										</div>
										<div class="card-body">
											...
											<table id="example" class="table table-striped table-bordered border-t0 text-nowrap w-100" >
												<thead>
													<tr class="text-center">
														...
														<th class="wd-30p">分类名</th>
														<th class="wd-30p">创建时间</th>
													...
													<tr class="text-center">
														...
														<td>
															<div class="btn-group align-top">
																		<a href="<?php echo url('type/edit?id='.$vo['id']); ?>" class="btn btn-sm btn-primary m-b-5 m-t-5">编辑分类</a>
																	</div>
															<div class="btn-group align-top">
		...
		<script>
		    ...
		    function btn(id,method,action){
		    	var url="<?php echo url('type/"+action+"'); ?>";
